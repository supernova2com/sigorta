<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="acentedurum.aspx.vb" Inherits="sigorta.acentedurum" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Acente Durum<small>Acente Durum kayıtlarını buradan yapabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Acente Durum Kaydı
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Acente Durum Adı:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Acente Durumu Tanımları
							</div>
...
<script type="text/javascript" src="js/acentedurum.js"></script>
