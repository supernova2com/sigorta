Public Partial Class tuzukdairearactipbag
    ...
    'yetkiler icin 
    Dim tabload As String = "tuzukdairearactipbag"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Label1.Text = tuzukdairearactipbag_erisim.listele()
            ...
            If Request.QueryString("op") = "duzenle" Then
                ...
                tuzukdairearactipbag = tuzukdairearactipbag_erisim.bultek(Request.QueryString("pkey"))
                DropDownList1.SelectedValue = tuzukdairearactipbag.tuzukaractippkey
                DropDownList2.SelectedValue = tuzukdairearactipbag.dairearactippkey
            End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If DropDownList1.SelectedValue = "0" Then
            DropDownList1.Focus()
            hata = "1"
            hatamesajlari = hatamesajlari + "Tüzükte tanımlı araç tipini seçmediniz.<br/>"
        End If

        If DropDownList2.SelectedValue = "0" Then
            DropDownList2.Focus()
            hata = "1"
            hatamesajlari = hatamesajlari + "Araç kayıt dairesinde tanımlı araç tipini seçmediniz.<br/>"
        End If
        ...
        If hata = "0" Then
            ...
            If Request.QueryString("op") = "yenikayit" Then
                tuzukdairearactipbag.tuzukaractippkey = DropDownList1.SelectedValue
                tuzukdairearactipbag.dairearactippkey = DropDownList2.SelectedValue
                result = tuzukdairearactipbag_erisim.Ekle(tuzukdairearactipbag)
            End If
            ...
            If Request.QueryString("op") = "duzenle" Then
                ...
                tuzukdairearactipbag.tuzukaractippkey = DropDownList1.SelectedValue
                tuzukdairearactipbag.dairearactippkey = DropDownList2.SelectedValue
                result = tuzukdairearactipbag_erisim.Duzenle(tuzukdairearactipbag)
            End If
    ...
    Private Sub Buttonsil_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Buttonsil.Click
        ...
        Dim tuzukdairearactipbag_erisim As New CLASSTUZUKDAIREARACTIPBAG_ERISIM
        result = tuzukdairearactipbag_erisim.Sil(Request.QueryString("pkey"))
        HttpContext.Current.Session("ltip") = "TÜMÜ"
        Label1.Text = tuzukdairearactipbag_erisim.listele()
        durumlabel.Text = javascript.alertresult(result)
    ...
    Protected Sub Buttonyenikayit_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles Buttonyenikayit.Click
        ...
        Response.Redirect("tuzukdairearactipbag.aspx?op=yenikayit")
        Button1.Text = "Kaydet"
