<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sifremiunuttumbilgi.aspx.vb" Inherits="sigorta.sifremiunuttumbilgi" %>
...
<div class="content">
	...
	<div class="forget-password">
			<p>		 
				<a href="bilgiyonetimgiris.aspx" id="forget-password">
					Giriş Ekranı
				</a>	 
			</p>		
		</div>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2014 &copy;  Kuzey Kıbrıs Türk Cumhuriyeti Sigorta ve Reasürans Şirketler Birliği
</div>
<!-- END COPYRIGHT -->
...
<!-- END JAVASCRIPTS -->
<script type="text/javascript" src="js/sifremiunuttumbilgi.js"></script>
</body>
<!-- END BODY -->
</html>
