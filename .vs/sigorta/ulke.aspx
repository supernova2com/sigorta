<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ulke.aspx.vb" Inherits="sigorta.ulke" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Ülkeler<small>Ülke tanımlarını bu sayfadan yapabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Ülke Kaydı
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Ülke Kod:</label>
                                <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Ülke Adı:</label>
                                <div class="col-md-4"> 
...
<script type="text/javascript" src="js/ulke.js"></script>
