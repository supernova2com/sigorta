<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cc.aspx.vb" Inherits="sigorta.cc" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					CC Zamları<small>CC Zamlarını giriniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>CC Zamları
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Başlangıç CC:</label>
                                <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Bitiş CC:</label>
                                <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> CC Zam Oranı:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>CC Zamları
							</div>
