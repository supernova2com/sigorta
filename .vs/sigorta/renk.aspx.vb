Public Partial Class renk
    ...
    Dim renk_erisim As New CLASSRENK_ERISIM

    'yetkiler icin 
    Dim tabload As String = "renk"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Label1.Text = renk_erisim.listele()

            If Request.QueryString("op") = "duzenle" Then
                Button1.Text = "Değişiklikleri Güncelle"
                renk = renk_erisim.bultek(Request.QueryString("pkey"))
                TextBox1.Text = renk.renkkod
                TextBox2.Text = renk.renkad
                TextBox3.Text = renk.renkhex
            End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If IsNumeric(TextBox1.Text) = False Then
            TextBox1.Focus()
            hata = "1"
            hatamesajlari = hatamesajlari + "Renk kodu girilmelidir ve rakamsal olmalıdır.<br/>"
        End If

        If TextBox2.Text = "" Then
            TextBox2.Focus()
            hata = "1"
            hatamesajlari = hatamesajlari + "Renk adını girmediniz.<br/>"
        End If

        If TextBox3.Text = "" Then
            TextBox3.Focus()
            hata = "1"
            hatamesajlari = hatamesajlari + "Renk hexadecimal kodu girmediniz.<br/>"
        End If
        ...
        If hata = "0" Then
            ...
            If Request.QueryString("op") = "yenikayit" Then
                renk.renkkod = TextBox1.Text
                renk.renkad = TextBox2.Text
                renk.renkhex = TextBox3.Text
                result = renk_erisim.Ekle(renk)
            End If
            ...
            If Request.QueryString("op") = "duzenle" Then
                ...
                renk.renkad = TextBox2.Text
                renk.renkhex = TextBox3.Text
                result = renk_erisim.Duzenle(renk)
            End If
    ...
    Private Sub Buttonsil_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Buttonsil.Click
        ...
        Dim renk_erisim As New CLASSRENK_ERISIM
        result = renk_erisim.Sil(Request.QueryString("pkey"))
        HttpContext.Current.Session("ltip") = "TÜMÜ"
        Label1.Text = renk_erisim.listele()
        durumlabel.Text = javascript.alertresult(result)
    ...
    Protected Sub Buttonyenikayit_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles Buttonyenikayit.Click
        ...
        Response.Redirect("renk.aspx?op=yenikayit")
        Button1.Text = "Kaydet"
