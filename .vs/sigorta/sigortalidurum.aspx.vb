Public Partial Class sigortalidurum
    ...
    'yetkiler icin 
    Dim tabload As String = "sigortalidurum"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            'TÜM GİRİLEN SİGORTALI DURUMLARINI LİSTELE
            HttpContext.Current.Session("ltip") = "TÜMÜ"
            Label1.Text = sigortalidurum_erisim.listele()

            If Request.QueryString("op") = "duzenle" Then
                Button1.Text = "Değişiklikleri Güncelle"
                sigortalidurum = sigortalidurum_erisim.bultek(Request.QueryString("pkey"))
                TextBox2.Text = sigortalidurum.ad
            End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If hata = "0" Then
            ...
            If Request.QueryString("op") = "yenikayit" Then
                sigortalidurum.ad = UCase(TextBox2.Text)
                result = sigortalidurum_erisim.Ekle(sigortalidurum)
            End If

            If Request.QueryString("op") = "duzenle" Then
                sigortalidurum = sigortalidurum_erisim.bultek(Request.QueryString("pkey"))
                sigortalidurum.ad = UCase(TextBox2.Text)
                result = sigortalidurum_erisim.Duzenle(sigortalidurum)
            End If
    ...
    Private Sub Buttonsil_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Buttonsil.Click
        ...
        Dim sigortalidurum_erisim As New CLASSSIGORTALIDURUM_ERISIM
        result = sigortalidurum_erisim.Sil(Request.QueryString("pkey"))
        HttpContext.Current.Session("ltip") = "TÜMÜ"
        Label1.Text = sigortalidurum_erisim.listele()
        durumlabel.Text = javascript.alertresult(result)
    ...
    Protected Sub Buttonyenikayit_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles Buttonyenikayit.Click
        ...
        Response.Redirect("sigortalidurum.aspx?op=yenikayit")
        Button1.Text = "Kaydet"
