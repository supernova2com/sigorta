...
Partial Public Class katilimbelge
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Else
                kullanici_erisim.busayfayigormeyeyetkilimi("katilimbelge", Session("kullanici_rolpkey"))
            End If
            'login kontrol -------------------------------------------
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        If hata = "0" Then
            ...
            If Len(personelpkeystring) > 0 Then
                ...
                personel_erisim.katilimbelgeolustur(personelpkeystring, verildigitarih)
            End If
