Public Partial Class vkolon
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Label1.Text = vtablo_erisim.listele_kolongirisicin()
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        HttpContext.Current.Session("ltip") = "tabloyagore"
        HttpContext.Current.Session("tabload") = DropDownList1.SelectedValue
        Label1.Text = vkolon_erisim.listele()
