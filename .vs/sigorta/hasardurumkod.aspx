<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="hasardurumkod.aspx.vb" Inherits="sigorta.hasardurumkod" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Hasar Durum Kodları<small>Hasar durum kodlarını bu sayfadan yapabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Hasar Durum Kodları
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Kod:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Hasar Durum Kodları
							</div>
...
<script type="text/javascript" src="js/hasardurumkod.js"></script>
