<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tmodul.aspx.vb" Inherits="sigorta.tmodul" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Modüller<small>Veri Giriş Modül Tanımlamaları</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">	
                           ...
                           <p>Veri giriş modüllerini ve o modüllerin kullanıldığı veritabanı tablolarını
                           tanımlayınız.
                            </p>			
						</div>
					</div>
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Veri Giriş Modül Kaydı
							</div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-4"> 
                                      ...
                                      maxlength="254" class="form-control" Height="100px" TextMode="MultiLine"/> 
                                </div>
                            </div> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Modüller
							</div>
...
<script type="text/javascript" src="js/tmodul.js"></script>
