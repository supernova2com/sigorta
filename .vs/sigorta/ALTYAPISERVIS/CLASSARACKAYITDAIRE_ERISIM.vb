...
Public Class CLASSARACKAYITDAIRE_ERISIM
    ...
    Function topluguncelle() As CLADBOPRESULT
        ...
        komut.Connection = db_baglanti
        sqlstr = "update arackayitdaire set " + _
        "MotorGuc=@MotorGuc1" + _
        " where Tip=@Tip and " + _
        " MotorGuc=@MotorGuc"
        komut = New SqlCommand(sqlstr, db_baglanti)

        Dim param1 As New SqlParameter("@MotorGuc1", SqlDbType.Int)
        param1.Direction = ParameterDirection.Input
        param1.Value = 50
        komut.Parameters.Add(param1)

        Dim param2 As New SqlParameter("@Tip", SqlDbType.VarChar, 100)
        param2.Direction = ParameterDirection.Input
        param2.Value = "Motobisiklet"
        komut.Parameters.Add(param2)

        Dim param3 As New SqlParameter("@MotorGuc", SqlDbType.Int)
        param3.Direction = ParameterDirection.Input
        param3.Value = 499
        komut.Parameters.Add(param3)
