Public Partial Class dairearactip
    ...
    'yetkiler icin 
    Dim tabload As String = "dairearactip"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Label1.Text = dairearactip_erisim.listele()

            If Request.QueryString("op") = "duzenle" Then
                Button1.Text = "Değişiklikleri Güncelle"
                dairearactip = dairearactip_erisim.bultek(Request.QueryString("pkey"))
                TextBox1.Text = dairearactip.dairearactipad
            End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If hata = "0" Then
            ...
            If Request.QueryString("op") = "yenikayit" Then
                dairearactip.dairearactipad = TextBox1.Text
                result = dairearactip_erisim.Ekle(dairearactip)
            End If

            If Request.QueryString("op") = "duzenle" Then
                dairearactip = dairearactip_erisim.bultek(Request.QueryString("pkey"))
                dairearactip.dairearactipad = TextBox1.Text
                result = dairearactip_erisim.Duzenle(dairearactip)
            End If
    ...
    Private Sub Buttonsil_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Buttonsil.Click
        ...
        Dim dairearactip_erisim As New CLASSDAIREARACTIP_ERISIM
        result = dairearactip_erisim.Sil(Request.QueryString("pkey"))
        HttpContext.Current.Session("ltip") = "TÜMÜ"
        Label1.Text = dairearactip_erisim.listele()
        durumlabel.Text = javascript.alertresult(result)
    ...
    Protected Sub Buttonyenikayit_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles Buttonyenikayit.Click
        ...
        Response.Redirect("dairearactip.aspx?op=yenikayit")
        Button1.Text = "Kaydet"
