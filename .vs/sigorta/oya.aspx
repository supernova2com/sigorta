<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="oya.aspx.vb" Inherits="sigorta.oya" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Ödeme Yapmayan Acenteler<small>Ödeme Yapmayan Acenteler ile ilgili İşlemler</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">	
                           ...
                           <p>Ödeme yapmayan acenteler ile ilgili işlemleri bu ekrandan yapabilirsiniz. </p>
						...
						<div class="portlet-body">
							            ...
							            <div class="col-md-6">
									       <div class="form-group">
										        <label class="control-label col-md-4">Acente:</label>
										        <div class="col-md-8">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Ödeme Yapmayan Acente Girişi
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Acente:</label>
                                <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Acente Durumu:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Ödeme Yapmayan Acenteler
							</div>
...
<script type="text/javascript" src="js/oya.js"></script>
