<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="header.ascx.vb" Inherits="sigorta.header" %>
<!DOCTYPE html>
...
<!-- ANA SAYFA PLAKAYA GÖRE ARAMA -->
 <script type="text/javascript" src="js/anasayfaara.js"></script> 
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        TableManaged.init();
        $.sessionTimeout({
            title: 'Uzun süredir işlem yapmadınız',
            message: 'Güvenlik nedeniyle sizi giriş ekranına yönlendiriyoruz...',
            keepAliveUrl: 'profile.aspx',
            redirUrl: 'extra_lock.aspx',
            logoutUrl: 'logout.aspx',
            warnAfter: 2000000, //warn after 20 minutes
					...
					<span class="sidebar-search">
						<div class="form-container">
							<div class="input-box">
								...
								-->
								<input id="plakainput" type="text" placeholder="Plaka ..."/>
								<input id="plakaarabutton" type="button" class="submit" value=" "/>
							</div>
						</div>
					</span>
