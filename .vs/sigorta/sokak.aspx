<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sokak.aspx.vb" enableEventValidation="false" Inherits="sigorta.sokak" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Sokak<small> Bu sayfada sokak kayıtlarını düzenleyebilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">	
                           ...
                           <p>Bu bölümde sokak kayıtları üzerinde ekleme, düzenleme ve silme işlemleri yapabilirsiniz.</p>
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Yeni Sokak
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Sokak Türü:</label>
                                  <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Sokak Adı:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Sokaklar
							</div>
...
<script type="text/javascript" src="js/sokak.js"></script>
