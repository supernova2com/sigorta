<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="urunkod.aspx.vb" Inherits="sigorta.urunkod" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Ürün Kodları<small>Ürün kod tanımlarını bu sayfadan yapabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Ürün Kodları
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Ürün Kod:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Ürün Kodları
							</div>
...
<script type="text/javascript" src="js/urunkod.js"></script>
