<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="plakadis.aspx.vb" Inherits="sigorta.plakadis" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Plaka<small> Araç kayıt dairesi kontrolu dışında tutulacak plaka kayıtlarını bu ekrandan yapabilirsiniz. Burada 
					düzeltme işlemi yaptığınızda otomatik olarak lokal veritabanında tutulan cc bilgisi de güncellenir.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">	
                           ...
                           <p>Buraya girdiğiniz plakalar Araç Kayıt Dairesi CC kontrolüne girmezler. Araç Kayıt Dairesi tarafından 
                           yanlış CC ile kaydedilmiş plakaları bu ekrandan giriniz. </p>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">   
                                    <asp:button class="btn yellow" id="Buttonarackayit" runat="server" text="Araç Kayıt Dairesinden Bul" />                                  
                                </div>
                            </div>  
                                          
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Doğru CC:</label>
                                <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Araç Kayıt CC:</label>
                                <div class="col-md-4"> 
...
<script type="text/javascript" src="js/plakadis.js"></script>
