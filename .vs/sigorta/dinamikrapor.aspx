<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dinamikrapor.aspx.vb" Inherits="sigorta.dinamikrapor" %>
		...
		<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Dinamik Raporlar<small>Dinamik rapor tanımlayabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">	
                           ...
                           <p>Bu ekrandan dinamik raporlar tanımlayabilirsiniz.</p>
					...
					<!-- DİNAMİK RAPOR YARAT PORTLATE-->
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Tanımlanmış Dinamik Raporlar
							</div>
							...
							<div class="actions">
								<a id="iframeyenikayit" href="dinamikraporpopup.aspx?op=yenikayit" class="btn green btn-sm">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-search"></i>Dinamik Rapor Çalıştır
							</div>
