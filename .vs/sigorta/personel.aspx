<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="personel.aspx.vb" Inherits="sigorta.personel" %>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							...
							<div class="actions">
								<a id="iframeyenikayit" runat="server" href="personelgirispopup.aspx?op=yenikayit" class="btn green btn-sm">
									<i class="fa fa-plus"></i> Yeni Kayıt
								</a>
                                <asp:button id="Buttoneposta" class="btn blue btn-sm" text="E-Posta Listesi Oluştur"  runat="server"></asp:button>
							</div>	
