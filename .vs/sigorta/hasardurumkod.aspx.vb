Public Partial Class hasardurumkod
    ...
    'yetkiler icin 
    Dim tabload As String = "hasardurumkod"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            kullanici_erisim.busayfayigormeyeyetkilimi("hasardurumkod", Session("kullanici_rolpkey"))
        End If
        'login kontrol -------------------------------------------
        ...
        If Not Page.IsPostBack Then
            ...
            Label1.Text = hasardurumkod_erisim.listele()

            If Request.QueryString("op") = "duzenle" Then
                Button1.Text = "Değişiklikleri Güncelle"
                hasardurumkod = hasardurumkod_erisim.bultek(Request.QueryString("pkey"))
                TextBox1.Text = hasardurumkod.kod
                TextBox2.Text = hasardurumkod.aciklama
            End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If TextBox1.Text = "" Then
            TextBox1.Focus()
            hata = "1"
            hatamesajlari = hatamesajlari + "Hasar durum kodu girilmelidir.<br/>"
        End If

        If Len(TextBox1.Text) > 3 Then
            TextBox1.Focus()
            hata = "1"
            hatamesajlari = hatamesajlari + "Hasar durum kodu en fazla 2 karakter olmalıdır.<br/>"
        End If
        ...
        If hata = "0" Then
            ...
            If Request.QueryString("op") = "yenikayit" Then
                hasardurumkod.kod = UCase(TextBox1.Text)
                hasardurumkod.aciklama = UCase(TextBox2.Text)
                result = hasardurumkod_erisim.Ekle(hasardurumkod)
            End If
            ...
            If Request.QueryString("op") = "duzenle" Then
                ...
                hasardurumkod.kod = UCase(TextBox1.Text)
                hasardurumkod.aciklama = UCase(TextBox2.Text)
                result = hasardurumkod_erisim.Duzenle(hasardurumkod)
            End If
    ...
    Private Sub Buttonsil_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Buttonsil.Click
        ...
        Dim hasardurumkod_erisim As New CLASSHASARDURUMKOD_ERISIM
        result = hasardurumkod_erisim.Sil(Request.QueryString("pkey"))
        HttpContext.Current.Session("ltip") = "TÜMÜ"
        Label1.Text = hasardurumkod_erisim.listele()
        durumlabel.Text = javascript.alertresult(result)
    ...
    Protected Sub Buttonyenikayit_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles Buttonyenikayit.Click
        ...
        Response.Redirect("hasardurumkod.aspx?op=yenikayit")
        Button1.Text = "Kaydet"
