<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="aracmarka.aspx.vb" Inherits="sigorta.aracmarka" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Araç Markaları<small>Araç marka tanımlarını bu sayfadan yapabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Araç Marka Kaydı
							</div>
						...
						<div class="portlet-body">
	                       ...
	                       <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Araç Marka Adı:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Araç Markaları
							</div>
...
<script type="text/javascript" src="js/aracmarka.js"></script>
