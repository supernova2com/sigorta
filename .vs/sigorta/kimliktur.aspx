<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="kimliktur.aspx.vb" Inherits="sigorta.kimliktur" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Kimlik Türleri<small>Kimlik tür tanımlarını bu sayfadan yapabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Kimlik Türü Kaydı
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Kimlik Türü Kod:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Kimlik Türleri
							</div>
...
<script type="text/javascript" src="js/kimliktur.js"></script>
