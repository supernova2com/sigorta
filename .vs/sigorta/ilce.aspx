<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ilce.aspx.vb" Inherits="sigorta.ilce" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					İlçe<small> Bu sayfada ilçe kayıtlarını düzenleyebilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">	
                           ...
                           <p>Bu bölümde ilçe kayıtları üzerinde ekleme, düzenleme ve silme işlemleri yapabilirsiniz.</p>
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Yeni İlçe
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> İlçe Adı:</label>
                                <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> İlçe Kodu:</label>
                                <div class="col-md-4"> 
