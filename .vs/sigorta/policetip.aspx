<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="policetip.aspx.vb" Inherits="sigorta.policetip" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Poliçe Tipleri<small>Poliçe tiplerini bu sayfadan tanımlayabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Poliçe Tipleri
							</div>
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Poliçe Tipleri
							</div>
...
<script type="text/javascript" src="js/policetip.js"></script>
