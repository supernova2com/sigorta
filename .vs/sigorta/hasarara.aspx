<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="hasarara.aspx.vb" Inherits="sigorta.hasarara" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Hasar Arama<small>Hasarları bu ekrandan sorgulayabilirsiniz.</small>
					</h3>
...
<script type="text/javascript" src="js/hasarara.js?rld=345jklkl346"></script>
