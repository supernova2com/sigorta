<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="log.aspx.vb" Inherits="sigorta.log" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Loglar<small>Sistemde yapılan hareketleri buradan takip edebilirsiniz.</small>
					</h3>
							        ...
							        <div class="row">
								        <div class="col-md-6">
									        <div class="form-group">
										        <label class="control-label col-md-4">Ortam:</label>
										        <div class="col-md-8">
