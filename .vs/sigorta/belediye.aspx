<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="belediye.aspx.vb" enableEventValidation="false" Inherits="sigorta.belediye" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Belediye<small> Bu sayfada belediye kayıtlarını düzenleyebilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">	
                           ...
                           <p>Bu bölümde belediye kayıtları üzerinde ekleme, düzenleme ve silme işlemleri yapabilirsiniz.</p>
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Yeni Belediye
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Belediye Adı:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Belediyeler
							</div>
...
<script type="text/javascript" src="js/belediye.js"></script>
