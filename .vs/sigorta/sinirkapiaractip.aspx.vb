Public Partial Class sinirkapiaractip
    ...
    'yetkiler icin 
    Dim tabload As String = "sinirkapiaractip"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            'TÜM GİRİLEN ARAÇ TİPLERİNİ LİSTELE
            HttpContext.Current.Session("ltip") = "TÜMÜ"
            Label1.Text = sinirkapiaractip_erisim.listele()

            If Request.QueryString("op") = "duzenle" Then
                Button1.Text = "Değişiklikleri Güncelle"
                sinirkapiaractip = sinirkapiaractip_erisim.bultek(Request.QueryString("pkey"))
                TextBox1.Text = sinirkapiaractip.sinirkapiaractipad
            End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If hata = "0" Then
            ...
            If Request.QueryString("op") = "yenikayit" Then
                sinirkapiaractip.sinirkapiaractipad = TextBox1.Text
                result = sinirkapiaractip_erisim.Ekle(sinirkapiaractip)
            End If

            If Request.QueryString("op") = "duzenle" Then
                sinirkapiaractip = sinirkapiaractip_erisim.bultek(Request.QueryString("pkey"))
                sinirkapiaractip.sinirkapiaractipad = TextBox1.Text
                result = sinirkapiaractip_erisim.Duzenle(sinirkapiaractip)
            End If
    ...
    Private Sub Buttonsil_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Buttonsil.Click
        ...
        Dim sinirkapiaractip_erisim As New CLASSSINIRKAPIARACTIP_ERISIM
        result = sinirkapiaractip_erisim.Sil(Request.QueryString("pkey"))
        HttpContext.Current.Session("ltip") = "TÜMÜ"
        Label1.Text = sinirkapiaractip_erisim.listele()
        durumlabel.Text = javascript.alertresult(result)
    ...
    Protected Sub Buttonyenikayit_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles Buttonyenikayit.Click
        ...
        Response.Redirect("sinirkapiaractip.aspx?op=yenikayit")
        Button1.Text = "Kaydet"
