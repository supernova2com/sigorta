<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ihalesinir.aspx.vb" Inherits="sigorta.ihalesinir" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					İhale Tipi Poliçelerde Sınırlandırma<small> İhale tipi poliçeleride sınırlandırma</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>İhale Poliçelerini Sınırlandırma
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Maks Yükleyebileceği Adet:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>İhale Tipi Poliçelerin Sınırlandırılması
							</div>
...
<script type="text/javascript" src="js/ihalesinir.js"></script>
