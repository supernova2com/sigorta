<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="headerbilgi.ascx.vb" Inherits="sigorta.headerbilgi" %>
<!DOCTYPE html>
...
<div class="header navbar navbar-fixed-top">
	...
	<div class="header-inner">
		...
		<a class="navbar-brand" href="default.aspx">
			<img src="assets/img/logo-bilgi.png" alt="logo" class="img-responsive hidden-xs"/>
		</a>
		<!-- END LOGO -->
