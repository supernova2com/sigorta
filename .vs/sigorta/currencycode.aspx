<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="currencycode.aspx.vb" Inherits="sigorta.currencycode" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Para Birimleri<small>Para birimi tanımlarını bu sayfadan yapabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Para Birimleri
							</div>
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Para Birimleri
							</div>
...
<script type="text/javascript" src="js/currencycode.js"></script>
