<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="false" EnableEventValidation="false" CodeBehind="sirketkullanici.aspx.vb" Inherits="sigorta.sirketkullanici" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Kullanıcılar<small>Bu sayfada sizin şirketinize bağlı kullanıcılarınızı tanımlayabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">	
                           ...
                           <p>Sisteme erişimi olacak olan kullanıcıları bu ekrandan tanımlayabilirsiniz. </p>
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
								...
								<div class="form-group">						
									<label class="col-md-3 control-label">Kullanıcı Ad Soyad:</label> 
									<div class="col-md-4">   
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Kullanıcı Ekleme
							</div>
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-md-4"> 
                                      ...
                                      maxlength="254" class="form-control"/>    
                                       <span class="help-block">TP'yi büyük harf yazınız. TP ile rakamlar 
                                       arasında boşluk bırakmayınız. Örnek:TP001.</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4"> 
                                    ...
                                    data-off-label="<i class='fa fa-times'></i>">  
                                     <span class="help-block">Aktif ise kullanıcı sisteme giriş yapabilir. 
                                     Pasif ise giriş yapamaz.</span>      
                                </div>
                            </div>                  
 
    
                            <div class="form-group">
                                <label class="col-md-3 control-label"> E-Posta Adresi:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Kullanıcılar
							</div>
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Kullanıcılarıma Tanımlayabileceğim Rollerin Açıklamaları
							</div>
...
<script type="text/javascript" src="js/sirketkullanici.js?relk=747"></script>
