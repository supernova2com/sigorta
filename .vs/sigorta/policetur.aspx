<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="policetur.aspx.vb" Inherits="sigorta.policetur" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Poliçe Türleri<small>Poliçe Tür tanımlarını bu sayfadan yapabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Poliçe Tür Kaydı
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Poliçe Tür Adı:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Poliçe Türleri
							</div>
...
<script type="text/javascript" src="js/policetur.js"></script>
