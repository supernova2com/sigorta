<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="risktype.aspx.vb" Inherits="sigorta.risktype" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Risk Tipleri<small> Risk Tipleri (RiskType) tanımlarını bu sayfadan yapabilirsiniz.</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="risktype.aspx">
							   Risk Tipleri (RiskType)
							</a>
						</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i>Risk Tipleri Kaydı
							</div>
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Risk Tipi Kod:</label>
                                <div class="col-md-4"> 
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Risk Tipleri (RiskType)
							</div>
...
<script type="text/javascript" src="js/risktype.js"></script>
