<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="false" CodeBehind="policesilyap.aspx.vb" Inherits="sigorta.policesilyap" %>
...
<head><title>Poliçe Silme İşlemi</title></head>

<uc1:header id="header1" runat="server" /> 
<script type="text/javascript" src="js/policesilyap.js"></script>   
...
<body style="font-size:75%; margin-top:0px; margin-left:0px;">
  ...
  <div id="tabsbilgi" style="width:100%;">
	...
	<form id="form1" runat="server" class="uniForm">
        ...
        <h4>Poliçeyi silmeden önce aşağıdaki XML'i bilgisayarınıza kaydediniz. Hatalı bir 
            silme işlemi durumunda bu kayıt ile poliçeyi sisteme tekrardan 
            kaydedebilirsiniz.</h4>  
