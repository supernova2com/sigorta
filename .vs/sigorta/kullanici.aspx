<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="kullanici.aspx.vb" enableEventValidation="false" Inherits="sigorta.kullanici" %>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Kullanıcılar<small>Bu sayfada sistemi kullanmaya yetkili kullanıcıları tanımlayabilirsiniz.</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Resim:</label>
                                <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Mesajlar Ayrıca E-Mail Olarak Gönderilsin mi?</label>
                                <div class="col-md-4"> 
                                    ...
                                    data-on-label="<i class='fa fa-check'></i>" 
                                    data-off-label="<i class='fa fa-times'></i>"> 
                                    <span class="help-block">Aktif yaparsanız sistem üzerinden 'Mesajlarım' menüsünden 
                                    o kullanıcıya atılan tüm mesajlar ayrıca kullanıcının tanımlanmış e-posta adresine de 
                                    otomatik olarak gönderilir.</span>
                                </div>
                            </div> 
