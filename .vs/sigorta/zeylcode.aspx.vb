Public Partial Class zeylcode
    ...
    'yetkiler icin 
    Dim tabload As String = "ZeylCode"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            kullanici_erisim.busayfayigormeyeyetkilimi("zeylcode", Session("kullanici_rolpkey"))
        End If
        'login kontrol -------------------------------------------
        ...
        If Not Page.IsPostBack Then
            ...
            Label1.Text = zeylcode_erisim.listele()

            If Request.QueryString("op") = "duzenle" Then
                Button1.Text = "Değişiklikleri Güncelle"
                zeylcode = zeylcode_erisim.bultek(Request.QueryString("pkey"))
                TextBox1.Text = zeylcode.kod
                TextBox2.Text = zeylcode.aciklama
            End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If TextBox1.Text = "" Then
            TextBox1.Focus()
            hata = "1"
            hatamesajlari = hatamesajlari + "Zeyil kodu girilmelidir.<br/>"
        End If

        If Len(TextBox1.Text) > 1 Then
            TextBox1.Focus()
            hata = "1"
            hatamesajlari = hatamesajlari + "Zeyil kodu tek karakterden oluşmalıdır.<br/>"
        End If
        ...
        If hata = "0" Then
            ...
            If Request.QueryString("op") = "yenikayit" Then
                zeylcode.kod = UCase(TextBox1.Text)
                zeylcode.aciklama = UCase(TextBox2.Text)
                result = zeylcode_erisim.Ekle(zeylcode)
            End If
            ...
            If Request.QueryString("op") = "duzenle" Then
                ...
                zeylcode.kod = UCase(TextBox1.Text)
                zeylcode.aciklama = UCase(TextBox2.Text)
                result = zeylcode_erisim.Duzenle(zeylcode)
            End If
    ...
    Private Sub Buttonsil_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Buttonsil.Click
        ...
        Dim zeylcode_erisim As New CLASSZEYLCODE_ERISIM
        result = zeylcode_erisim.Sil(Request.QueryString("pkey"))
        HttpContext.Current.Session("ltip") = "TÜMÜ"
        Label1.Text = zeylcode_erisim.listele()
        durumlabel.Text = javascript.alertresult(result)
    ...
    Protected Sub Buttonyenikayit_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles Buttonyenikayit.Click
        ...
        Response.Redirect("zeylcode.aspx?op=yenikayit")
        Button1.Text = "Kaydet"
