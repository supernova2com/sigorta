...
Partial Public Class policeara_parakambiyo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            kullanici_erisim.busayfayigormeyeyetkilimi("policeara_parakambiyo", Session("kullanici_rolpkey"))
        End If
        'login kontrol -------------------------------------------
        ...
        If Not Page.IsPostBack Then
            ...
            If plaka <> "" Then
                ...
                HttpContext.Current.Session("bitis") = DateTime.Now
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        If TextBox6.Text = "" And TextBox7.Text = "" And TextBox8.Text = "" And _
